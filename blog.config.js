...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '9941abdfaf7546f7a098c7a5a3ae9293',
  ...
  AUTHOR: '范春春', // 作者
  BIO: '春春的数字花园', // 作者简介
  LINK: 'https://blog.fanchunchun.xyz', // 网站地址
  KEYWORDS: '春春, 数字花园, 景观, 设计, Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: '865504483@qq.com', // 邮箱
  CONTACT_WEIBO: 'https://weibo.com/u/1938426455', // 你的微博个人主页
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '9ccdbfefbd3a00d2cd9c9d984ec377b6', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-6624D6G6TJ', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
